...
%%
program: external_declaration  {$$ = CreateNewAstNode("","__list__",$1,NULL);}
       | program external_declaration  {$$ = CreateNewAstNode("","__list__",$1,$2);}
       | program EOP {ShowAst($$,0);FreeAst($$);printf("Parser Finished\n");system("pause");exit(1);}
       ;
...
parameter_list: parameter {$$ = CreateNewAstNode("","__list__",$1,NULL);}
              ...
              ;
parameter: type ID {$$ = CreateNewAstNode("","FunctionParameter",$1,CreateNewAstNode("$2","ParameterName",NULL,NULL));}
         ;
